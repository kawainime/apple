          ...
          m.chat,
          {
            contextInfo: {
              externalAdReply: {
                ...
                body: ownername,
                previewType: "PHOTO",
                thumbnail: fs.readFileSync("./XliconMedia/theme/mek.jpg"),
                sourceUrl: wagc,
              },
            },
            text: teks,
    ...
    const fkontak = {
      ...
      message: {
        contactMessage: {
          ...
          vcard: `BEGIN:VCARD\nVERSION:3.0\nN:XL;${ownername},;;;\nFN:${ownername}\nitem1.TEL;waid=6285648973328:6285648973328\nitem1.X-ABLabel:Mobile\nEND:VCARD`,
          jpegThumbnail: thumb,
          thumbnail: thumb,
          sendEphemeral: true,
        },
      ...
      message: {
        imageMessage: {
          ...
          directPath:
            "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69",
          mediaKeyTimestamp: "1610993486",
          jpegThumbnail: fs.readFileSync("./XliconMedia/theme/mek.jpg"),
          scansSidecar:
            "1W0XhfaAcDwc7xh1R8lca6Qg/1bB4naFCSngM2LKO2NoP5RI7K+zLw==",
        },
      },
    ...
    if (db.data.settings[botNumber].autobio) {
      XliconBotInc.updateProfileStatus(
        `${botname} 📃 𝐇𝐚𝐯𝐞 𝐁𝐞𝐞𝐧 𝐑𝐮𝐧𝐧𝐢𝐧𝐠 💻 ${runtime(
          process.uptime()
        )}...                                   ~𝐒𝐓𝐀𝐑 ⭐ 𝐓𝐡𝐞 𝐁𝐨𝐭 𝐑𝐞𝐩𝐨𝐬𝐢𝐭𝐨𝐫𝐲 𝐎𝐧 𝐆𝐢𝐭𝐇𝐮𝐛...                       🏮
     `
      ).catch((_) => _);
    }
    //auto type record
      ...
      case "sim":
        {
          ...
          await fsx.copy(delb, "./XliconMedia/theme/mek.jpg");
          fs.unlinkSync(delb);
          replygcXlicon(mess.done);
        }
        break;
...
${themeemoji} URL: ${repoData.html_url}
 ...
 `.trim();
      ...
      case "premiumuser":
        {
          let teks = `Hi ${pushname}👋\nHallo My Friends Ingin Membeli Saldo? Silakan Ketik #owner`;
          await XliconBotInc.sendMessage(
            m.chat,
            {
              text: teks,
      ...
      case "sourcecode":
        {
          let me = m.sender;
          let teks = `*「  ${global.botname} Deposit 」*\n\nYouTube: ${
            global.websitex
          }\nGitHub: ${global.botscript}\n\nHi @${
            me.split("@")[0]
          } 👋\nHallo Teman² Ingin Deposit Via Apa Nih?`;
      ...
      case "help":
        {
          ...
          let xmenu_oh = `
┌─❖
│ *_Hi_* _Selamat Datang Di Toko RootSec Bot_ 👋 
└┬❖  ${pushname} 
 ✑  ${xeonytimewisher} 😄 
  └────────────┈ ▱╼❲⭐❳
${readmore}
...
${mot} 𝗡𝗮𝗺a: ${pushname}
${mot} 𝗡omor: +${me.split("@")[0]}
${mot} 𝗟𝗶𝗺𝗶𝘁: ${a.limit}
${mot} Pengguna: ${a.title ? a.title : "-"}
${mot} SN: ${a.serialNumber}

 
⏤͟͟͞͞★ Waktu Hari Ini ꗄ➺ 
...
╰▱╼❲⭐❳`;
      ...
      case "allmenu":
        {
          let xmenu_oh = `*Berikut Ini Adalah Semua Menu*...👋🏻 *${pushname}*
        ...
        \n${readmore}\n\n${allmenu(prefix, hituet)}`;
          if (typemenu === "v1") {
            XliconBotInc.sendMessage(
              m.chat,
              {
                image: fs.readFileSync("./XliconMedia/theme/mek.jpg"),
                caption: xmenu_oh,
              },
              {
                quoted: m,
